...
document.addEventListener("DOMContentLoaded", () => {
    ...
    let addInpunt = document.querySelector("#item");
    ...
    //CLICKEANDO EL BOTON AGREGA EL ITEM EN LA LISTA
    ...
    addInpunt.addEventListener("keypress", function(e) {
        //PRESIONANDO ENTER AGREGA EL ITEM EN LA LISTA
        if (13 === e.keyCode) {
            let newItem = document.querySelector("#item").value;
    ...
    function addItemTodo(text) {
        ...
        item.innerText = text;
        //CREA UN DIV PARA AGREGAR EL ITEM CON SUS DOS BOTONES LOS CUALES TOMAN LA CLASE BUTTONS CON SU MISMA CARACTERISTICA
        let buttons = document.createElement('div');
        buttons.classList.add("buttons");

        //AGREGA EL ICONO REMOVE SVG
